  ...
  public static class Arithmetic implements SampleConstraint {
    ...
    public Constraint getConstraint() {
      ...
      formulas.add(new NodeOperation(StandardOperation.EQ, a, new NodeOperation(
          StandardOperation.ADD, new NodeOperation(StandardOperation.MUL, new NodeValue(intType
              .valueOf("2", 10)), c), new NodeValue(intType.valueOf("10", 10)))));

      formulas.add(new NodeOperation(StandardOperation.LESSEQ, new NodeOperation(
          StandardOperation.ADD, c, b), new NodeValue(intType.valueOf("1000", 10))));

      formulas.add(new NodeOperation(StandardOperation.GREATEREQ, d, e));
