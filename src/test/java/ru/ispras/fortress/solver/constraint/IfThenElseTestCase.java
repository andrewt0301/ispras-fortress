  ...
  public static class IfThenElse implements SampleConstraint {
    ...
    public Constraint getConstraint() {
      ...
      formulas.add(new NodeOperation(
        StandardOperation.GREATER, a, new NodeValue(intType.valueOf("5", 10))));

      formulas.add(new NodeOperation(
        StandardOperation.LESS, b, new NodeValue(intType.valueOf("7", 10))));

      formulas.add(new NodeOperation(StandardOperation.EQ, new NodeOperation(StandardOperation.ITE,
        new NodeOperation(StandardOperation.EQ, a, b), new NodeValue(intType.valueOf("1", 10)),
        new NodeValue(intType.valueOf("0", 10))), new NodeValue(intType.valueOf("1", 10)))
      );
