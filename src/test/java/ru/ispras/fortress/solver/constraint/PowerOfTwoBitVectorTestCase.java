...
public class PowerOfTwoBitVectorTestCase extends GenericSolverTestBase {
  ...
  public static class PowerOfTwo implements SampleConstraint {
    ...
    public Constraint getConstraint() {
      ...
      formulas
          .add(new NodeOperation(StandardOperation.EQ, new NodeOperation(StandardOperation.BVAND,
              x, new NodeOperation(StandardOperation.BVSUB, x, new NodeValue(BIT_VECTOR_TYPE
                  .valueOf("1", 10)))), new NodeValue(BIT_VECTOR_TYPE.valueOf("0", 10))));
