...
public class BitVectorMathTestCase
{
    ...
    public void uleTests()
    {
        ...
        checkBitVector(BitVectorMath.ule(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0x7FFFFFFF, 32)), BitVector.FALSE);
        checkBitVector(BitVectorMath.ule(BitVector.valueOf(0x7FFFFFFF, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.TRUE);
    ...
    {
        checkBitVector(BitVectorMath.uge(BitVector.newEmpty(16),    BitVector.newEmpty(16)),    BitVector.TRUE);
        checkBitVector(BitVectorMath.uge(BitVector.valueOf(-1, 16), BitVector.valueOf(0, 16)),  BitVector.TRUE);
        checkBitVector(BitVectorMath.uge(BitVector.valueOf(-1, 16), BitVector.valueOf(-1, 16)), BitVector.TRUE);

        checkBitVector(BitVectorMath.uge(BitVector.valueOf(0xF98A, 16), BitVector.valueOf(0xF98A, 16)), BitVector.TRUE);
        checkBitVector(BitVectorMath.uge(BitVector.valueOf(0xFFFF, 16), BitVector.valueOf(0xFF0F, 16)), BitVector.TRUE);
    ...
    {
        checkBitVector(BitVectorMath.ugt(BitVector.newEmpty(16),    BitVector.newEmpty(16)),    BitVector.FALSE);
        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(-1, 16), BitVector.valueOf(0, 16)),  BitVector.TRUE);
        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(-1, 16), BitVector.valueOf(-1, 16)), BitVector.FALSE);

        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0xF98A, 16), BitVector.valueOf(0xF98A, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0xFFFF, 16), BitVector.valueOf(0xFF0F, 16)), BitVector.TRUE);

        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0x7FFE, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFE, 16)), BitVector.TRUE);

        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.FALSE);
        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0xFFFFFFFE, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.FALSE);
        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0xFFFFFFFE, 32)), BitVector.TRUE);

        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0x7FFFFFFF, 32)), BitVector.TRUE);
        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0x7FFFFFFF, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.FALSE);

        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0xFFFFFFFFFFFFFFFEL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64)), BitVector.FALSE);
        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFEL, 64)), BitVector.TRUE);

        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0x7FFFFFFFFFFFFFFFL, 64)), BitVector.TRUE);
        checkBitVector(BitVectorMath.ugt(BitVector.valueOf(0x7FFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64)), BitVector.FALSE);
    }

    @Test
    public void sleTests()
    {
        checkBitVector(BitVectorMath.sle(BitVector.newEmpty(16),    BitVector.newEmpty(16)),    BitVector.TRUE);
        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0xFFFF, 16), BitVector.valueOf(0, 16)),  BitVector.TRUE);

        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0xF000, 16), BitVector.valueOf(0xFFFF, 16)), BitVector.TRUE);
        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0xFFFE, 16), BitVector.valueOf(0xFFFF, 16)), BitVector.TRUE);
        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.TRUE);
        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0x7000, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.TRUE);

        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0xF98A, 16), BitVector.valueOf(0xF98A, 16)), BitVector.TRUE);
        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0xFFFF, 16), BitVector.valueOf(0xFF0F, 16)), BitVector.FALSE);

        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.TRUE);
        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0x7FFE, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.TRUE);
        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFE, 16)), BitVector.FALSE);

        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.TRUE);

        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0x7FFFFFFF, 32)), BitVector.TRUE);
        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0x7FFFFFFF, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.FALSE);

        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0xFFFFFFFE, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.TRUE);
        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0xFFFFFFFE, 32)), BitVector.FALSE);

        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0xFFFFFFFFFFFFFFFEL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64)), BitVector.TRUE);
        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFEL, 64)), BitVector.FALSE);

        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0x7FFFFFFFFFFFFFFFL, 64)), BitVector.TRUE);
        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0x7FFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64)), BitVector.FALSE);
    }

    @Test
    public void sltTests()
    {
        checkBitVector(BitVectorMath.slt(BitVector.newEmpty(16),        BitVector.newEmpty(16)),        BitVector.FALSE);
        checkBitVector(BitVectorMath.sle(BitVector.valueOf(0xFFFF, 16), BitVector.valueOf(0, 16)),      BitVector.TRUE);

        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0xF000, 16), BitVector.valueOf(0xFFFF, 16)), BitVector.TRUE);
        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0xFFFE, 16), BitVector.valueOf(0xFFFF, 16)), BitVector.TRUE);
        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0x7000, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.TRUE);

        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0xF98A, 16), BitVector.valueOf(0xF98A, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0xFFFF, 16), BitVector.valueOf(0xFF0F, 16)), BitVector.FALSE);

        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0x7FFE, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.TRUE);
        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFE, 16)), BitVector.FALSE);

        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.FALSE);

        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0x7FFFFFFF, 32)), BitVector.TRUE);
        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0x7FFFFFFF, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.FALSE);

        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0xFFFFFFFE, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.TRUE);
        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0xFFFFFFFE, 32)), BitVector.FALSE);

        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0xFFFFFFFFFFFFFFFEL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64)), BitVector.TRUE);
        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFEL, 64)), BitVector.FALSE);

        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0x7FFFFFFFFFFFFFFFL, 64)), BitVector.TRUE);
        checkBitVector(BitVectorMath.slt(BitVector.valueOf(0x7FFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64)), BitVector.FALSE);
    }

    @Test
    public void sgeTests()
    {
        checkBitVector(BitVectorMath.sge(BitVector.newEmpty(16),        BitVector.newEmpty(16)),        BitVector.TRUE);
        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0xFFFF, 16), BitVector.valueOf(0, 16)),      BitVector.FALSE);

        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0xF000, 16), BitVector.valueOf(0xFFFF, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0xFFFE, 16), BitVector.valueOf(0xFFFF, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.TRUE);
        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0x7000, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.FALSE);

        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0xF98A, 16), BitVector.valueOf(0xF98A, 16)), BitVector.TRUE);
        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0xFFFF, 16), BitVector.valueOf(0xFF0F, 16)), BitVector.TRUE);

        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.TRUE);
        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0x7FFE, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFE, 16)), BitVector.TRUE);

        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.TRUE);

        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0x7FFFFFFF, 32)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0x7FFFFFFF, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.TRUE);

        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0xFFFFFFFE, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0xFFFFFFFE, 32)), BitVector.TRUE);

        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0xFFFFFFFFFFFFFFFEL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFEL, 64)), BitVector.TRUE);

        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0x7FFFFFFFFFFFFFFFL, 64)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sge(BitVector.valueOf(0x7FFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64)), BitVector.TRUE);
    }

    @Test
    public void sgtTests()
    {
        checkBitVector(BitVectorMath.sgt(BitVector.newEmpty(16),        BitVector.newEmpty(16)),        BitVector.FALSE);
        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0xFFFF, 16), BitVector.valueOf(0, 16)),      BitVector.FALSE);

        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0xF000, 16), BitVector.valueOf(0xFFFF, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0xFFFE, 16), BitVector.valueOf(0xFFFF, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0x7000, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.FALSE);

        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0xF98A, 16), BitVector.valueOf(0xF98A, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0xFFFF, 16), BitVector.valueOf(0xFF0F, 16)), BitVector.TRUE);

        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0x7FFE, 16), BitVector.valueOf(0x7FFF, 16)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0x7FFF, 16), BitVector.valueOf(0x7FFE, 16)), BitVector.TRUE);

        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.FALSE);

        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0x7FFFFFFF, 32)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0x7FFFFFFF, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.TRUE);

        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0xFFFFFFFE, 32), BitVector.valueOf(0xFFFFFFFF, 32)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0xFFFFFFFF, 32), BitVector.valueOf(0xFFFFFFFE, 32)), BitVector.TRUE);

        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0xFFFFFFFFFFFFFFFEL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFEL, 64)), BitVector.TRUE);

        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0x7FFFFFFFFFFFFFFFL, 64)), BitVector.FALSE);
        checkBitVector(BitVectorMath.sgt(BitVector.valueOf(0x7FFFFFFFFFFFFFFFL, 64), BitVector.valueOf(0xFFFFFFFFFFFFFFFFL, 64)), BitVector.TRUE);
    }
}
