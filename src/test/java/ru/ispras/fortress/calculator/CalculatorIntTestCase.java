 ...
 * All rights reserved.
 * 
 * CalculatorIntTestCase.java, Nov 5, 2014 3:14:39 PM Andrei Tatarnikov
 * 
...
public final class CalculatorIntTestCase
{
    ...
    public void testPLUSOperation()
    {
        ...
        testEquals(Data.newInteger(Long.MIN_VALUE), StandardOperation.PLUS, Data.newInteger(Long.MIN_VALUE));
        testEquals(Data.newInteger(Long.MAX_VALUE), StandardOperation.PLUS, Data.newInteger(Long.MAX_VALUE));
    }
    ...
    public void testADDOperation()
    {
        testEquals(
            Data.newInteger(0),
            StandardOperation.ADD, Data.newInteger(0), Data.newInteger(0)
        );

        testEquals(
            Data.newInteger(0),
            StandardOperation.ADD, Data.newInteger(1), Data.newInteger(-1)
        );
    ...
    public void testSUBOperation()
    {
        testEquals(
            Data.newInteger(0),
            StandardOperation.SUB, Data.newInteger(0), Data.newInteger(0)
        );

        testEquals(
            Data.newInteger(2),
            StandardOperation.SUB, Data.newInteger(1), Data.newInteger(-1)
        );
    ...
    public void testMULOperation()
    {
        testEquals(
            Data.newInteger(0),
            StandardOperation.MUL, Data.newInteger(0), Data.newInteger(0)
        );

        testEquals(
            Data.newInteger(-1),
            StandardOperation.MUL, Data.newInteger(1), Data.newInteger(-1)
        );
