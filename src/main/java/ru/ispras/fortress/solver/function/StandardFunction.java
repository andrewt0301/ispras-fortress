 ...
 * All rights reserved.
 * 
 * StandardFunction.java, Dec 16, 2013 4:41:13 PM Andrei Tatarnikov
 * 
 ...
 * describing functions that perform the job of corresponding 
 * standard operations (see {@link StandardOperation}). 
 * 
...
{
    /**
     * The items below are function templates for operations from
     * the "Logic Arithmetic" group.
     */
    ...
    MIN (StandardOperation.MIN, 2)
    {
        ...
        protected Function newFunction(DataType[] argTypes)
        {
            return StandardFunctionFactory.makeMin(
                getId(), argTypes[0], argTypes[1]);
        }
    },
    ...
    MAX (StandardOperation.MAX, 2)
    {
        ...
        protected Function newFunction(DataType[] argTypes)
        {
            return StandardFunctionFactory.makeMax(
                getId(), argTypes[0], argTypes[1]);
        }
    },

    /**
     * The items below are function templates for operations
     * from the "Bit Vector Reduction Operations" group.
     * 
     * Operation semantics:
     * <pre>
