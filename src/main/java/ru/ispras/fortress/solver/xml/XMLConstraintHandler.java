...
final class XMLConstraintHandler extends DefaultHandler {
  ...
  private static String getAttribute(String nodeName, Attributes attributes, String attributeName)
      throws SAXException {
  ...
  private static void verifyFormatVersion(String nodeName, Attributes attributes)
      throws SAXException {
  ...
  private static void verifyNodeHierarchy(XMLNodeType current, XMLNodeType parent)
      throws SAXException {
...
final class XMLConstraintBuilder {
  ...
  private final Stack<OperationBuilder> operations = new Stack<OperationBuilder>();
