...
/**
 * The {@link TransformerRule} is an interface to be implemented by all rules being
 * used in {@link NodeTransformer}.
 */
public interface TransformerRule {
   ...
   *
   * @param node Expression node the rule will be applied to.
