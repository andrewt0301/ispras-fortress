...
/**
 * The Calculator class is responsible for performing calculations on data
 * objects using an extendable set of operations. It encapsulates a table
 * of calculator engines each implementing operations that belong to some
 * logic group. Each group is represented by a enumeration identifying
 * operations it contains. The class of the enumeration is used to identify
 * engines implementing operations from the given group. It is possible to
 * extend functionality by registering custom engines implementing new group
 * of operations. Also, you can replace existing engines with custom engines
 * if needed.      
 * 
...
public final class Calculator
{
    ...
    /**
     * A singleton for the calculator engine that implements standard
     * operations described by the StandardOperation enumeration. 
     */
    ...
    /**
     * Registers a calculator engine that performs calculations using
     * operations that belong to the given operation group which is
     * described with a corresponding enumeration. The class of the
     * enumeration serves as a key.
     * 
     * @param operationIdClass Class of the enumeration that identifies
     * operations implemented by the given calculator engine.
     * @param engine Calculator engine to be registered.
     * @return <code>true</code> if the engine was successfully registered and
     * it had not been previously registered or <code>false</code> if an engine
     * identified by the specified class had already been registered (in this
     * case, it is replaced with a new engine).
     * 
    ...
    /**
     * Returns the engine that performs calculations using a specific group
     * of operations. Operations that belong to a single group are identified
     * with a corresponding enumeration. The class of the enumeration serves
     * as a key. If no such engine is registered <code>null</code> is returned.
     * 
     * @param operationIdClass Class of the enumeration that identifies
     * operations implemented by the given engine.
     * @return Engine responsible for performing a specific group of
     * operations or <code>null</code> if no such engine is registered.
     * 
    ...
    /**
     * Checks whether the specified operation is supported for the provided
     * operands. The class of the operation identifier, its value and operand
     * types are taken into consideration.
     * 
     * @param operationId Operation identifier. Identifies an operation within
     * a group.
     * @param operands A variable number of operands.
     * @return <code>true</code> if the operation is supported for the given
     * operand types or <code>false</code> otherwise.
     * 
     * @throws NullPointerException if any of the parameters equals null.
     */
    ...
    public static Data calculate(Enum<?> operationId, Data ... operands)
    {
        ...
        if (null == engine)
        {
            throw new UnsupportedOperationException(
                String.format(MSG_UNSUPPORTED_GROUP_FRMT,
                    operationId.getClass().getSimpleName()));
        }
