 ...
 */
public final class BiasedRandomVariate<T> implements RandomVariate<T> {
   ...
   */
  public BiasedRandomVariate(final List<T> values, final List<Integer> biases) {
   ...
   *         sizes or they are empty or the {@code biases} array contains negative numbers.
   */
  public BiasedRandomVariate(final T[] values, final int[] biases) {
